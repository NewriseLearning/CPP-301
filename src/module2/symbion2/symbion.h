...
#ifndef SYMBION2_EXPORTS
#define SYMBION2_API __declspec(dllimport)
#else
#define SYMBION2_API __declspec(dllexport)
#endif
...
namespace symbion {
	...
	class SYMBION2_API CBaseLogger {
	private:
		char* m_source;
	public:
		CBaseLogger();
...
//		virtual void Write(const char* message, LogType logType) const abstract;
	...
	class SYMBION2_API CDebugLogger : public CBaseLogger {
	public:
		CDebugLogger();
	...
	class SYMBION2_API CFileLogger : public CBaseLogger {
	private:
		char* m_filename;
	public:
		CFileLogger();
	...
	class SYMBION2_API CLoggerFactory {
	private:
