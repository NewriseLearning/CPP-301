...
public:
	void Write(const std::_tstring& message, mylog::LogType type) const override {
		WORD eventType = 0;	// uint16_t eventType = 0;
		switch (type) {
			case mylog::LogType::Information: eventType = EVENTLOG_INFORMATION_TYPE; break;
			case mylog::LogType::Warning: eventType = EVENTLOG_WARNING_TYPE; break;
			case mylog::LogType::Error: eventType = EVENTLOG_ERROR_TYPE; break;
		}
